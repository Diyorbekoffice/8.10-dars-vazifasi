    ...
    <div>
      <div className="maindiv mx-auto px-20 pb-[120px] pt-16 ">
        <div className=" flex justify-between">
          <Image src="/Logo (2).svg" alt="Description of image" width={108}  height={24} className="cursor-pointer" />
        ...
        <div className=" flex flex-col gap-[200px]">
          <div className="page_1 flex items-center g-24">
            <div className="max-w-[632px] mx-auto">
              ...
              <p className="text-lg font-bold mb-[27px]"> Determining what level of hiker you are can be an important tool when planning future hikes. This hiking level guide will help you plan hikes according to different hike ratings set by various websites like All Trails and Modern Hiker. What type of hiker are you – novice, moderate, advanced moderate, expert, or expert backpacker?{" "} </p>
          ...
          <div className="page_2 flex items-center">
            ...
            <div className="max-w-[632px] mx-auto">
              ...
              <p className="text-lg font-bold mb-[27px]">The nice thing about beginning hiking is that you don’t really need any special gear, you can probably get away with things you already have. Let’s start with clothing. A typical mistake hiking beginners make is wearing jeans and regular clothes, which will get heavy and chafe wif they get sweaty or wet. </p>
          ...
          <div className="page_3 flex items-center">
            <div className="max-w-[632px] mx-auto">
              ...
              <p className="text-lg font-bold mb-[27px]"> To start, print out the hiking guide and map. If it’s raining, throw them in a Zip-Lock bag. Read over the guide, study the map, and have a good idea of what to expect. I like to know what my next landmark is as I hike. For example, I’ll read the guide and know that say, in a mile, I make a right turn at the junction.. </p>
          ...
          <footer className="flex justify-between">
            <div className="flex flex-col max-w-[355px] gap-6">
              ...
              <p className="text-lg font-bold mb-[98px]"> Get out there & discover your next slope, mountain & destination! </p>
